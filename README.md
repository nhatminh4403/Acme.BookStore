...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 4f689747-efb6-44fa-a94f-46f95b2a4bfe
```

> `4f689747-efb6-44fa-a94f-46f95b2a4bfe` is the password of the certificate, you can change it to any password you want.
